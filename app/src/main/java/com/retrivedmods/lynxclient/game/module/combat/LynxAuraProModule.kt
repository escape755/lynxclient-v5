...
import com.retrivedmods.lynxclient.game.ListItem
...
import com.retrivedmods.lynxclient.game.entity.Item
...
class LynxAuraProModule : Module("LynxAuraPro", ModuleCategory.Combat) {
    ...
    private fun updateTargets(localPlayer: com.retrivedmods.lynxclient.game.entity.LocalPlayer) {
        targets.clear()
        for (entity in session.level.entityMap.values) {
            ...
            val isMob = entity is EntityUnknown && entity !is Item &&
                entity.identifier in com.retrivedmods.lynxclient.game.entity.MobList.mobTypes && !isPlayer
    ...
    private fun adaptiveClassify(localPlayer: com.retrivedmods.lynxclient.game.entity.LocalPlayer, tgt: TData): Int {
