...
class ZAuraModule : Module("ZAura", ModuleCategory.Combat) {

    private var playersOnly by boolValue("players_only", true)
    private var mobsOnly by boolValue("mobs_only", false)

    private var rangeValue by floatValue("range", 50f, 2f..100f)
    private var cpsValue by intValue("cps", 25, 1..100) // Very high CPS
    private var boost by intValue("packets", 2, 1..30)
